...
export const Footer = () => {
  return (
    <footer className={s.footerContainer}>
      ...
      <a
        className={s.icon}
        href="https://www.instagram.com/plitka_dest.crew?igsh=MXA2cTd0ejdvdzFlaA=="
      >
        <svg
      ...
      <a
        className={s.films}
        href={"https://youtu.be/BuxEPJ8bDXU?si=4CJHaZ_YzrBjw335"}
      >
        <h3>Films</h3>
      </a>
      <address>
      <h3 style={{ fontStyle: "normal" }}>Пн—Вс 10:00—21:00</h3>

      <h3 style={{ fontStyle: "normal" }}>Т. +375 (29) 715 55 40</h3>
      </address>
