...
function Jackets() {
  ...
  const uniqueColors = Array.from(
    new Set(data.map((product: JacketsType) => product.color))
  ).sort();
  const uniqueSizes = Array.from(
    new Set(data.map((product: JacketsType) => product.size))
  ).sort();
  const uniqueBrands = Array.from(
    new Set(data.map((product: JacketsType) => product.company))
  ).sort();
